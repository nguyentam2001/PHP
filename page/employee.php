      ...
      <div class="right flex-center">
        <div class="search m-r-24">
          <form action="employee.php" method="GET">
            ...
            <input type="text" class="input-search" name="search" id="searchText" placeholder="Tên nhân viên...">
          </form>
        </div>
        <div class="t-btn-wrapper">
          <button type="button" id="addEmployee" class="btn btn-warning"> <i class="fa-solid fa-user-plus"></i>Thêm</button>
        </div>
      </div>
    </div>
