   ...
   <body>
       <div class="navbar">
           ...
           <div class="navbar-list">
               <a <?php
                    if ($_SERVER['SCRIPT_NAME'] == "/ntstore/page/overview.php") { ?> class="link-active item p-l-12 flex-center" <?php } ?> class="item p-l-12 flex-center" href="overview.php">
                   <div class="over-view-icon icon-base"></div>
                   <div class="over-view m-l-8 text">Tổng quan</div>
               </a>
               <a <?php if ($_SERVER['SCRIPT_NAME'] == "/ntstore/page/product.php") { ?> class="link-active item p-l-12 flex-center" <?php } ?> class="item p-l-12 flex-center" href="product.php">
                   <div class="category-icon icon-base"></div>
                   <div class="category m-l-8 text">
                       Sản phẩm
                   </div>
               </a>
               <a <?php if ($_SERVER['SCRIPT_NAME'] == "/ntstore/page/category.php") { ?> class="link-active item p-l-12 flex-center" <?php } ?> class="item p-l-12 flex-center" href="category.php">
                   <div class="category-icon icon-base"></div>
                   <div class="category m-l-8 text">
                       Danh mục sản phẩm
                   </div>
